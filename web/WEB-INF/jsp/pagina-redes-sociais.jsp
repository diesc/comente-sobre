        ...
        <script>
            ...
            $(".btn").click(function() {
                ...
                if (name === '' || email === '' || comment === '') {
                    ...
                    jQuery.ajax({
                        type: "POST",
                        url: "/comente-sobre/adicionarRede.htm",
                        data: str,
                        async: false,
                        cache: false,
                        success: function() {
                            ...
                            $("#email").val('');
                            $("#comment").val('');
                            $("#success_msg").load('/comente-sobre/redes-sociais.htm  .comment_box');
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="formAction">
                <c:url var="urlComentario" value="adicionarRede.htm"/>
